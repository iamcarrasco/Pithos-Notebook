...
pub fn build_command_entries() -> Vec<CommandEntry> {
    vec![
        ...
        CommandEntry { label: "Copy as HTML".into(), accel: "".into(), action_name: "win.copy-html".into() },
        ...
        CommandEntry { label: "Toggle Hemingway Mode".into(), accel: "".into(), action_name: "win.toggle-hemingway".into() },
        CommandEntry { label: "Toggle Focus Mode".into(), accel: "".into(), action_name: "win.toggle-focus-mode".into() },
        CommandEntry { label: "Toggle Typewriter Scrolling".into(), accel: "".into(), action_name: "win.toggle-typewriter".into() },
        CommandEntry { label: "Cycle Preview Theme".into(), accel: "".into(), action_name: "win.cycle-preview-theme".into() },
...
// ---------------------------------------------------------------------------
// Misc dialogs (backlinks, history, rename)
// ---------------------------------------------------------------------------
