...
Pithos Notebook is a private, offline markdown notebook. Your notes are encrypted with AES-256-GCM and never leave your machine — no cloud, no accounts, no tracking.
