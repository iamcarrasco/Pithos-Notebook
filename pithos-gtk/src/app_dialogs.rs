...
/// Wire a passphrase strength indicator to a password entry.
fn wire_passphrase_strength(entry: &gtk::PasswordEntry, label: &gtk::Label) {
...
pub fn show_create_vault_dialog(window: &adw::ApplicationWindow) {
    ...
    wire_passphrase_strength(&pass1, &strength_label);
...
pub fn show_change_passphrase_dialog(ctx: &EditorCtx) {
    ...
    wire_passphrase_strength(&new_pass1, &strength_label);
